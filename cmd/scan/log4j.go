...
var fixes = map[string]map[string]string{
	"org.apache.logging.log4j": {
		"log4j-core": "Upgrade to version org.apache.logging.log4j:log4j-core:2.17.1",
	},
	"org.ops4j.pax.logging": {
		"pax-logging-log4j2": "Upgrade to version org.ops4j.pax.logging:pax-logging-log4j2:2.0.13",
	},
}
